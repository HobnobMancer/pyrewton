...
tax.class_tax_ri_ari_df <- stat.bact.class_tax_ri_ari_df
tax.class_tax_ri_ari_df$`Eukaryote Mean` <- stat.euk.class_tax_ri_ari_df$Mean
tax.class_tax_ri_ari_df$`Eukaryote Standard Deviation` <- stat.euk.class_tax_ri_ari_df$`Standard Deviation`
tax.class_tax_ri_ari_df$`All Mean` <- stat.all.class_tax_ri_ari_df$Mean
tax.class_tax_ri_ari_df$`All Standard Deviation` <- stat.all.class_tax_ri_ari_df$`Standard Deviation`

kable(tax.class_tax_ri_ari_df, caption="Overall performance of CAZy class classification (represented by the Rand Index) by CAZy classifiers per taxonomy group", align='c', digits = 4) %>% kable_styling(full_width = F)
...
kable(tax.class_tax_ri_ari_df, caption="Overall performance of CAZy class classification (represented by the Adjusted Rand Index) by CAZy classifiers per taxonomy group", align='c', digits = 4) %>% kable_styling(full_width = F)
