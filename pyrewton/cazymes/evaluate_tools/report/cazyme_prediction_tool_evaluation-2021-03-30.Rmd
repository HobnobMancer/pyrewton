...
bact.cazy_class_df <- read.csv("data/class_stats_per_test_set_tax_comparison_Bacteria_2021_12_01.csv")
euk.cazy_class_df <- read.csv("data/class_stats_per_test_set_tax_comparison_Eukaryote_2021_12_01.csv")

# import class_classification_tax_comparison_<date>.csv
# df containing CAZy class RI and ARI
class_tax_ri_ari_df <- read.csv("data/class_classification_tax_comparison_2021_12_01.csv")
...
```{r famsSense, echo=FALSE, fig.cap="Scatter plot of overlaying a one-dimensional box-and-whisker plot of sensitivity for each CAZy family for each CAZyme classifier. Each CAZy family is represented as a single point on the plot."}
# set order data is presented
cazy_fam_spec_sense_df$Prediction_tool <- factor(cazy_fam_spec_sense_df$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
...
<!-- ```{r gtfamPoorFam1, echo=FALSE, fig.cap="Scatter plot of recall (sensitivity) against specificity for predicting each CAZy family for each CAZyme classifier in the CAZy class GlycosylTransferases."} -->
...
<!-- ```{r gtfamPoorFam2, echo=FALSE, fig.cap="GT families which at least 3 tools scored and Fbeta-score of less than 0.75. The nubmer in bold next to each CAZy family is the number of known CAZymes from the CAZy family included across all test sets."} -->
...
<!-- ```{r plfamPoorFam1, echo=FALSE, fig.cap="Scatter plot of recall (sensitivity) against specificity for predicting each CAZy family for each CAZyme classifier in the CAZy class Polysaccharide Lyases."} -->
...
<!-- ```{r plfamPoorFam2, echo=FALSE, fig.cap="PL families which at least 3 tools scored and Fbeta-score of less than 0.75. The nubmer in bold next to each CAZy family is the number of known CAZymes from the CAZy family included across all test sets."} -->
...
<!-- ```{r cefamPoorFam1, echo=FALSE, fig.cap="Scatter plot of recall (sensitivity) against specificity for predicting each CAZy family for each CAZyme classifier in the CAZy class Carbohydrate Esterases."} -->
...
<!-- ```{r cefamPoorFam2, echo=FALSE, fig.cap="CE families which at least 3 tools scored and Fbeta-score of less than 0.75. The nubmer in bold next to each CAZy family is the number of known CAZymes from the CAZy family included across all test sets."} -->
...
<!-- ```{r aafamPoorFam1, echo=FALSE, fig.cap="Scatter plot of recall (sensitivity) against specificity for predicting each CAZy family for each CAZyme classifier in the CAZy class Auxiliary Activities."} -->
...
<!-- ```{r aafamPoorFam2, echo=FALSE, fig.cap="AA families which at least 3 tools scored and Fbeta-score of less than 0.75. The nubmer in bold next to each CAZy family is the number of known CAZymes from the CAZy family included across all test sets."} -->
...
<!-- ```{r cbmfamPoorFam1, echo=FALSE, fig.cap="Scatter plot of recall (sensitivity) against specificity for predicting each CAZy family for each CAZyme classifier in the CAZy class Carbohydrate-Binding Module."} -->
...
<!-- ```{r cbmfamPoorFam2, echo=FALSE, fig.cap="CBM families which at least 3 tools scored and Fbeta-score of less than 0.75. The nubmer in bold next to each CAZy family is the number of known CAZymes from the CAZy family included across all test sets."} -->
...
bact.tax_binary_f1_mean_sd <- tax_binary_f1_df.bact %>% group_by(Prediction_tool) %>% summarise("Bacterial Mean"=mean(Statistic_value), "Bacterial Standard Deviation"=sd(Statistic_value))
euk.tax_binary_f1_mean_sd <- tax_binary_f1_df.euk %>% group_by(Prediction_tool) %>% summarise("Eukaryote Mean"=mean(Statistic_value), "Eukaryote Standard Deviation"=sd(Statistic_value))
all.tax_binary_f1_mean_sd <- all.tax_binary_f1_df %>% group_by(Prediction_tool) %>% summarise("All Mean"=mean(Statistic_value), "All Standard Deviation"=sd(Statistic_value))

tax_binary_f1_mean_sd <- bact.tax_binary_f1_mean_sd
tax_binary_f1_mean_sd$`Eukaryote Mean` <- euk.tax_binary_f1_mean_sd$`Eukaryote Mean`
tax_binary_f1_mean_sd$`Eukaryote Standard Deviation` <- euk.tax_binary_f1_mean_sd$`Eukaryote Standard Deviation`
...
tax_binary_f1_mean_sd$Prediction_tool <- factor(tax_binary_f1_mean_sd$Prediction_tool, levels=c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented

kable(tax_binary_f1_mean_sd, caption="Overall performance of binary CAZyme/non-CAZyme classification by CAZy classifiers per taxonomy group", align='c', digits = 4) %>% kable_styling(full_width = F)
...
build.tax.group.binary.plot <- function(stat_parameter, tax.df){
  ...
  tax_binary_stat$Prediction_tool <- factor(tax_binary_stat$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented
  ...
  p.tax.binary = ggplot(complete.tax_binary_stat %>% group_by(Tax_group),
...
bact.cazy_class_df.f1 <- bact.cazy_class_df[which(bact.cazy_class_df$Statistic_parameter == "FBeta-score"), ]
bact.cazy_class_df.f1  <- bact.cazy_class_df.f1[complete.cases(bact.cazy_class_df.f1), ]
bact.cazy_class_df.f1.stat <- bact.cazy_class_df.f1 %>% group_by(Prediction_tool) %>% summarise("Mean F1-score"=mean(Statistic_value), "F1-score Standard Deviation"=sd(Statistic_value))

euk.cazy_class_df.f1 <- euk.cazy_class_df[which(euk.cazy_class_df$Statistic_parameter == "FBeta-score"), ]
euk.cazy_class_df.f1  <- euk.cazy_class_df.f1[complete.cases(euk.cazy_class_df.f1), ]
euk.cazy_class_df.f1.stat <- euk.cazy_class_df.f1 %>% group_by(Prediction_tool) %>% summarise("Mean F1-score"=mean(Statistic_value), "F1-score Standard Deviation"=sd(Statistic_value))
...
class_subset_f1  <- class_subset_f1[complete.cases(class_subset_f1), ]
all.cazy_class_df.f1.stat <- class_subset_f1 %>% group_by(Prediction_tool) %>% summarise("Mean F1-score"=mean(Statistic_value), "F1-score Standard Deviation"=sd(Statistic_value))

tax_class_f1_mean_sd <- bact.tax_binary_f1_mean_sd
tax_class_f1_mean_sd$`Eukaryote Mean` <- euk.cazy_class_df.f1.stat$`Mean`
tax_class_f1_mean_sd$`Eukaryote Standard Deviation` <- euk.cazy_class_df.f1.stat$`Standard Deviation`
...
tax_class_f1_mean_sd$Prediction_tool <- factor(tax_binary_f1_mean_sd$Prediction_tool, levels=c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented

kable(tax_class_f1_mean_sd, caption="Overall performance of CAZy class classification by CAZy classifiers per taxonomy group", align='c', digits = 4) %>% kable_styling(full_width = F)
...
stat.bact.class_tax_ri_ari_df <- bact.class_tax_ri_ari_df %>% group_by(Prediction_tool) %>% summarise("Bacteria Mean"=mean(Rand_index), "Bacteria Standard Deviation"=sd(Rand_index))
stat.euk.class_tax_ri_ari_df <- euk.class_tax_ri_ari_df %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Rand_index), "Standard Deviation"=sd(Rand_index))
stat.all.class_tax_ri_ari_df <- all.class_tax_ri_ari_df %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Rand_index), "Standard Deviation"=sd(Rand_index))

tax.class_tax_ri_df <- stat.bact.class_tax_ri_ari_df
tax.class_tax_ri_df$`Eukaryote Mean` <- stat.euk.class_tax_ri_ari_df$Mean
tax.class_tax_ri_df$`Eukaryote Standard Deviation` <- stat.euk.class_tax_ri_ari_df$`Standard Deviation`
...
tax.class_tax_ri_df$Prediction_tool <- factor(tax.class_tax_ri_df$Prediction_tool, levels=c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented
kable(tax.class_tax_ri_df, caption="Overall performance of CAZy class classification (represented by the Rand Index) by CAZy classifiers per taxonomy group", align='c', digits = 4) %>% kable_styling(full_width = F)
...
stat.bact.class_tax_ri_ari_df <- bact.class_tax_ri_ari_df %>% group_by(Prediction_tool) %>% summarise("Bacteria Mean"=mean(Adjusted_Rand_index), "Bacteria Standard Deviation"=sd(Adjusted_Rand_index))
stat.euk.class_tax_ri_ari_df <- euk.class_tax_ri_ari_df %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Adjusted_Rand_index), "Standard Deviation"=sd(Adjusted_Rand_index))
stat.all.class_tax_ri_ari_df <- all.class_tax_ri_ari_df %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Adjusted_Rand_index), "Standard Deviation"=sd(Adjusted_Rand_index))

tax.class_tax_ari_df <- stat.bact.class_tax_ri_ari_df
tax.class_tax_ari_df$`Eukaryote Mean` <- stat.euk.class_tax_ri_ari_df$Mean
tax.class_tax_ari_df$`Eukaryote Standard Deviation` <- stat.euk.class_tax_ri_ari_df$`Standard Deviation`
...
tax.class_tax_ari_df$Prediction_tool <- factor(tax.class_tax_ari_df$Prediction_tool, levels=c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented
kable(tax.class_tax_ari_df, caption="Overall performance of CAZy class classification (represented by the Adjusted Rand Index) by CAZy classifiers per taxonomy group", align='c', digits = 4) %>% kable_styling(full_width = F)
...
fam_classification_df_tax.ri.bact <- fam_classification_df_tax.bact %>% group_by(Prediction_tool) %>% summarise("Bacteria Mean"=mean(Rand_index), "Bacteria Standard Deviation"=sd(Rand_index))
fam_classification_df_tax.ri.euk <- fam_classification_df_tax.euk %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Rand_index), "Standard Deviation"=sd(Rand_index))
fam_classification_df_tax.ri.all <- fam_classification_df_tax.all %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Rand_index), "Standard Deviation"=sd(Rand_index))

fam_classification_df_tax.ri.complete <- fam_classification_df_tax.ri.bact
fam_classification_df_tax.ri.complete$`Eukaryote Mean` <- fam_classification_df_tax.ri.euk$`Mean`
fam_classification_df_tax.ri.complete$`Eukaryote Standard Deviation` <- fam_classification_df_tax.ri.euk$`Standard Deviation`
...
fam_classification_df_tax.ri.complete$Prediction_tool <- factor(fam_classification_df_tax.ri.complete$Prediction_tool, levels=c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented

kable(fam_classification_df_tax.ri.complete, caption="Rand Index of CAZyme classifier classification of CAZy family annotations per taxonomt group", align='c', digits = 4) %>% kable_styling(full_width = F)
```

```{r famAriCalcTax, echo=FALSE}
fam_classification_df_tax.ari.bact <- fam_classification_df_tax.bact %>% group_by(Prediction_tool) %>% summarise("Bacteria Mean"=mean(Adjusted_Rand_index), "Bacteria Standard Deviation"=sd(Adjusted_Rand_index))
fam_classification_df_tax.ari.euk <- fam_classification_df_tax.euk %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Adjusted_Rand_index), "Standard Deviation"=sd(Adjusted_Rand_index))
fam_classification_df_tax.ari.all <- fam_classification_df_tax.all %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Adjusted_Rand_index), "Standard Deviation"=sd(Adjusted_Rand_index))
...
fam_classification_df_tax.ari.complete$Prediction_tool <- factor(fam_classification_df_tax.ari.complete$Prediction_tool, levels=c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) # set order data is presented

kable(fam_classification_df_tax.ari.complete, caption="Adjusted Rand Index of CAZyme classifier classification of CAZy family annotations per taxonomt group", align='c', digits = 4) %>% kable_styling(full_width = F)
```
