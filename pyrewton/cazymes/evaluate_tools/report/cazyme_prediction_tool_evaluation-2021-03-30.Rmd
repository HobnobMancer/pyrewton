...
# set order data is presented
gh.subset$Prediction_tool <- factor(gh.subset$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
gt.subset$Prediction_tool <- factor(gt.subset$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
pl.subset$Prediction_tool <- factor(pl.subset$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
ce.subset$Prediction_tool <- factor(ce.subset$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
aa.subset$Prediction_tool <- factor(aa.subset$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
cbm.subset$Prediction_tool <- factor(cbm.subset$Prediction_tool, levels = c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')) 
...
get_poor_fams <- function(df){
  ...
  tools <- c('dbCAN','HMMER','DIAMOND','Hotpep','CUPP','eCAMI')
...
# generate plot
p.gh.poor.pops <- ggplot(gh.low.sens %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=Statistic_value)) +
  geom_tile() +
  scale_fill_viridis_c() +
  geom_text(data=gh.low.sens, aes(label=round(Statistic_value, digits=3))) +
  theme(legend.background = element_rect(fill = figbg, color = figbg),
        plot.background = element_rect(fill = figbg, color = figbg), 
...
# generate plot
p.gt.poor.pops <- ggplot(gt.low.sens %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=Statistic_value)) +
  geom_tile() +
  scale_fill_viridis_c() +
  geom_text(data=gt.low.sens, aes(label=round(Statistic_value, digits=3))) +
  theme(legend.background = element_rect(fill = figbg, color = figbg),
        plot.background = element_rect(fill = figbg, color = figbg), 
        text = element_text(size=10), 
        legend.text=element_text(size=10),
...
# generate plot
p.pl.poor.pops <- ggplot(pl.low.sens %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=Statistic_value)) +
  geom_tile() +
  scale_fill_viridis_c() +
  geom_text(data=pl.low.sens, aes(label=round(Statistic_value, digits=3))) +
  theme(legend.background = element_rect(fill = figbg, color = figbg),
        plot.background = element_rect(fill = figbg, color = figbg), 
        text = element_text(size=10), 
        legend.text=element_text(size=10),
...
# generate plot
p.ce.poor.pops <- ggplot(ce.low.sens %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=Statistic_value)) +
  geom_tile() +
  scale_fill_viridis_c() +
  geom_text(data=ce.low.sens, aes(label=round(Statistic_value, digits=3))) +
  theme(legend.background = element_rect(fill = figbg, color = figbg),
        plot.background = element_rect(fill = figbg, color = figbg), 
        text = element_text(size=10), 
        legend.text=element_text(size=10),
...
pdf(file = "poorFamSensCe.pdf", width = 8.58, height = 3.5)
p.ce.poor.pops
dev.off()
```
...
# generate plot
p.aa.poor.pops <- ggplot(aa.low.sens %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=Statistic_value)) +
  geom_tile() +
  scale_fill_viridis_c() +
  geom_text(data=aa.low.sens, aes(label=round(Statistic_value, digits=3))) +
  theme(legend.background = element_rect(fill = figbg, color = figbg),
        plot.background = element_rect(fill = figbg, color = figbg), 
        text = element_text(size=10), 
        legend.text=element_text(size=10),
...
pdf(file = "poorFamSensAa.pdf", width = 8.58, height = 5.5)
p.aa.poor.pops
dev.off()
```
...
# generate plot
p.cbm.poor.pops <- ggplot(cbm.low.sens %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=Statistic_value)) +
  geom_tile() +
  scale_fill_viridis_c() +
  geom_text(data=cbm.low.sens, aes(label=round(Statistic_value, digits=3))) +
  theme(legend.background = element_rect(fill = figbg, color = figbg),
        plot.background = element_rect(fill = figbg, color = figbg), 
        text = element_text(size=10), 
        legend.text=element_text(size=10),
...
bact.cazy_class_df.f1.stat <- bact.cazy_class_df.f1 %>% group_by(Prediction_tool) %>% summarise("Bacterial Mean"=mean(Statistic_value), "Bacterial Standard Deviation"=sd(Statistic_value))
...
euk.cazy_class_df.f1.stat <- euk.cazy_class_df.f1 %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Statistic_value), "Standard Deviation"=sd(Statistic_value))
...
class_subset_f1  <- class_subset_f1[complete.cases(class_subset_f1), ]
all.cazy_class_df.f1.stat <- class_subset_f1 %>% group_by(Prediction_tool) %>% summarise("Mean"=mean(Statistic_value), "Standard Deviation"=sd(Statistic_value))
