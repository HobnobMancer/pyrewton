...
# rename the columns
names(gassemblies)[names(gassemblies) == "ï..Group"] <- "Phylogeny"
...
# A contours for shading the density of the scatter plots cannot be produced if there are several points with the same value on the same axis. Therefore, the data used to create the scatter plot is copied and noise is added to it by corrupting the original data, and using the 'noisy data' to plot the contour and the original data to plot the scatter plot

recall.results <- cazy_class_GH_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.000001, max=0.0005))
  noisy.recall <- append(noisy.recall, i)
}
cazy_class_GH_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- cazy_class_GH_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.0002, max=0.0015))
  noisy.spec <- append(noisy.spec, i)
}
cazy_class_GH_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "classcGHSpecSens.pdf", width = 11.25, height = 7)
p.class.gh.spec.recall = ggplot(cazy_class_GH_spec_recall_df %>% group_by(Prediction_tool), aes(x=as.numeric(Recall), y=as.numeric(Specificity))) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
        axis.text=element_text(size=10),
        axis.title=element_text(size=11,face="bold"),
        strip.text = element_text(size=11)) +
  labs(x = "Sensitivity", y = "Specificity", fill="Density") +
  geom_boxplot(aes(x=Recall, y=0.8875), alpha=0.5, width=0.01, outlier.shape = NA) +
  scale_x_continuous(breaks = seq(0,1, by = 0.2), limits=c(0,1)) +
  scale_y_continuous(breaks = seq(0.875,1, by = 0.025), limits=c(0.875,1)) +
...
recall.results <- cazy_class_GT_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.000001, max=0.001))
  noisy.recall <- append(noisy.recall, i)
}
cazy_class_GT_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- cazy_class_GT_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.0002, max=0.002))
  noisy.spec <- append(noisy.spec, i)
}
cazy_class_GT_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "classcGTSpecSens.pdf", width = 11.25, height = 7)
...
spec.results <- cazy_class_PL_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.00002, max=0.0002))
  noisy.spec <- append(noisy.spec, i)
}
cazy_class_PL_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "classcPLSpecSens.pdf", width = 11.25, height = 7)
...
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.001))
  noisy.recall <- append(noisy.recall, i)
}
cazy_class_CE_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- cazy_class_CE_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.00015, max=0.0002))
  noisy.spec <- append(noisy.spec, i)
}
cazy_class_CE_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "classcCESpecSens.pdf", width = 11.25, height = 7)
p.class.ce.spec.recall = ggplot(cazy_class_CE_spec_recall_df %>% group_by(Prediction_tool), aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
        axis.text=element_text(size=10),
        axis.title=element_text(size=11,face="bold"),
...
spec.results <- cazy_class_AA_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.0002, max=0.0004))
  noisy.spec <- append(noisy.spec, i)
}
cazy_class_AA_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "classcAASpecSens.pdf", width = 11.25, height = 7)
...
spec.results <- cazy_class_CBM_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.0002, max=0.0004))
  noisy.spec <- append(noisy.spec, i)
}
cazy_class_CBM_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "classcCBMSpecSens.pdf", width = 11.25, height = 7)
...
The CAZyme prediction tools predict the CAZy family annotations for predicted CAZymes. A single CAZyme can be assigned to multiple CAZy families, producing a multilabel classification which was evaluated to summarise the overall performance of each prediction tool. In addition, the performance of each prediction tool against each CAZy family was also evaluated.

## Multilabel CAZy Family Prediction Performance

The multilabel classification of a CAZyme arises from a single CAZyme having the potential to be assigned to more than one CAZy family. Therefore, when a prediction tool is parsing a protein sequence it makes 458 classification decisions, one for each CAZy family. To address this and evaluate the multilabel classification of CAZy families the Rand Index (RI) and Adjusted Rand Index (ARI) were calculated. 
...
A single CAZyme can be included in multiple CAZy families, from multiple different CAZy classes, resulting in the multilabel classification of CAZymes. 

The RI is the measure of agreement across all potential classifications of a protein. The RI ranges from 0 (no correct annotations) to 1 (all annotations correct). Figure \@ref(fig:famRI) shows the RI result for all proteins parsed by the prediction tools.. The ARI is the RI adjusted for chance, where 0 is the equivalent to assigning the CAZy family annotations randomly, -1 where the annotations are systematically handed out incorrectly and 1 where the annotations are all correct. Figure \@ref(fig:famARI) shows the ARI for all proteins parsed by the prediction tools.
...
The RI and ARI demonstrate the performance of each prediction tool across all families, but it does not evaluate the performance against each family regardless of the performance of other families. Therefore, the RI and ARI does not enable the comparison between differences in performances for specific families. Here, the performance for each prediction tool across all test sets was evaluated for each CAzy family.

```{r familyStatsSetUp, include=FALSE}
# load in the data
...
Figure \@ref(fig:familSummaryFbetaScore) shows the performance of each prediction tool for each CAZy family included in the test sets and/or predicted to be present in the test sets. Each point in the plots is the result for one CAZy family. Results were not evaluated per test set, the performance for each CAZy family was evaluated across all test sets.
...
recall.results <- gh_cazy_fam_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.001))
  noisy.recall <- append(noisy.recall, i)
}
gh_cazy_fam_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- gh_cazy_fam_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.00002, max=0.00001))
  noisy.spec <- append(noisy.spec, i)
}
gh_cazy_fam_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "mlcGHfamsSpecSens.pdf", width = 11.25, height = 7)
p.gh.fam = ggplot(gh_cazy_fam_spec_recall_df, aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
  ...
  scale_y_continuous(breaks = seq(0.995,1, by = 0.001), limits=c(0.995,1)) +
  facet_wrap(~ Prediction_tool)
p.gh.fam
# dev.off()
```
...
recall.results <- gt_cazy_fam_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.001))
  noisy.recall <- append(noisy.recall, i)
}
gt_cazy_fam_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- gt_cazy_fam_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.00002, max=0.00001))
  noisy.spec <- append(noisy.spec, i)
}
gt_cazy_fam_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "mlcGTfamsSpecSens.pdf", width = 11.25, height = 7)
p.gt.fam = ggplot(gt_cazy_fam_spec_recall_df, aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
  ...
  scale_y_continuous(breaks = seq(0.9985,1, by = 0.0005), limits=c(0.9985,1)) +
  facet_wrap(~ Prediction_tool)
p.gt.fam
# dev.off()
```
...
#####
# these figures are created and then merged together mannually in another programme for inclusion in publications and the thesis
# tiff(file = "gtPoorFamsFbeta.tiff", units="cm", width = 15.5, height = 15, res=600)
...
# tiff(file = "gtPoorFamsPops.tiff", units="cm", width = 15.5, height = 12, res=600)
...
#### Sequence divergency of GT29 and 31

```{r gt29, echo=FALSE}
# gt29_alignment_output <- read.csv("gt29_alignment_output.csv")
# identity vs bitscore
# p_gt29_alignment_heatmap = ggplot(gt29_alignment_output, aes(x=identity, y=bitscore)) +
  # geom_bin2d() +
  # scale_fill_viridis()
# p_gt29_alignment_heatmap
```

```{r gt31, echo=FALSE}
# gt31_alignment_output <- read.csv("gt31_alignment_output.csv")
# identity vs bitscore
# p_gt31_alignment_heatmap = ggplot(gt31_alignment_output, aes(x=identity, y=bitscore)) +
  # geom_bin2d() +
  # scale_fill_viridis()
# p_gt31_alignment_heatmap
```
...
recall.results <- pl_cazy_fam_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.001))
  noisy.recall <- append(noisy.recall, i)
}
pl_cazy_fam_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- pl_cazy_fam_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.000002, max=0.0000045))
  noisy.spec <- append(noisy.spec, i)
}
pl_cazy_fam_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "mlcPLfamsSpecSens.pdf", width = 11.25, height = 7)
p.pl.fam = ggplot(pl_cazy_fam_spec_recall_df, aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
  ...
  scale_y_continuous(limits=c(0.99971,1)) +
  facet_wrap(~ Prediction_tool)
p.pl.fam
# dev.off()
...
#####
# these figures are created and then merged together mannually in another programme for inclusion in publications and the thesis
# tiff(file = "plPoorFamsFbeta.tiff", units="cm", width = 15.5, height = 9.5, res=600)
...
# tiff(file = "plPoorFamsPops.tiff", units="cm", width = 15.5, height = 7, res=600)
...
recall.results <- ce_cazy_fam_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.0001))
  noisy.recall <- append(noisy.recall, i)
}
ce_cazy_fam_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- ce_cazy_fam_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.0000001, max=0.0000001))
  noisy.spec <- append(noisy.spec, i)
}
ce_cazy_fam_spec_recall_df$Specifcity_Noise <- noisy.spec

# pdf(file = "mlcCEfamsSpecSens.pdf", width = 11.25, height = 7)
p.ce.fam = ggplot(ce_cazy_fam_spec_recall_df, aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
  ...
  scale_y_continuous(limits=c(0.9985,1)) +
  facet_wrap(~ Prediction_tool)
p.ce.fam
# dev.off()
```
...
#####
# these figures are created and then merged together mannually in another programme for inclusion in publications and the thesis
# tiff(file = "cePoorFamsFbeta.tiff", units="cm", width = 15.5, height = 6.5, res=600)
p.ce.poor.fam.fbeta_only <- ggplot(poor.ce.fam.melt %>% group_by(Prediction_tool), aes(x=Prediction_tool, y=CAZy_family, fill=value)) +
  ...
  labs(fill = expression(paste("F", beta, "-score"))) +
  scale_x_discrete(labels = function(x) str_wrap(x, width = 10))
# p.ce.poor.fam.fbeta_only
# dev.off()

# tiff(file = "cePoorFamsPops.tiff", units="cm", width = 15.5, height = 4.5, res=600)
p.ce.poor.fam.pops <- ggplot(ce_fam_freq_df, aes(x="", y=CAZy_family)) +
...
recall.results <- aa_cazy_fam_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.0001))
  noisy.recall <- append(noisy.recall, i)
}
aa_cazy_fam_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- aa_cazy_fam_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.0000001, max=0.0000001))
  noisy.spec <- append(noisy.spec, i)
}
aa_cazy_fam_spec_recall_df$Specifcity_Noise <- noisy.spec

  # scale_y_continuous(limits=c(0.9985,1)) +

# pdf(file = "mlcAAfamsSpecSens.pdf", width = 11.25, height = 7)
p.aa.fam = ggplot(aa_cazy_fam_spec_recall_df, aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
        ...
        strip.text = element_text(size=11)) +
  labs(x = "Sensitivity", y = "Specificity", fill="Density") +
  geom_boxplot(aes(x=Recall, y=0.998125), alpha=0.5, width=0.00015, outlier.shape = NA) +
  facet_wrap(~ Prediction_tool)
p.aa.fam
# dev.off()
```
...
#####
# these figures are created and then merged together mannually in another programme for inclusion in publications and the thesis
# tiff(file = "aaPoorFamsFbeta.tiff", units="cm", width = 15.5, height = 8.75, res=600)
...
# tiff(file = "aaPoorFamsPops.tiff", units="cm", width = 15.5, height = 7, res=600)
aa.poor.fam.pops <- ggplot(aa_fam_freq_df, aes(x="", y=CAZy_family)) +
...
recall.results <- cbm_cazy_fam_spec_recall_df$Recall
noisy.recall = c()
for(i in recall.results){
  i <- i - (runif(1, min=-0.00001, max=0.0001))
  noisy.recall <- append(noisy.recall, i)
}
cbm_cazy_fam_spec_recall_df$Recall_Noise <- noisy.recall

spec.results <- cbm_cazy_fam_spec_recall_df$Specificity
noisy.spec = c()
for(i in spec.results){
  i <- i - (runif(1, min=-0.000001, max=0.000001))
  noisy.spec <- append(noisy.spec, i)
}
cbm_cazy_fam_spec_recall_df$Specifcity_Noise <- noisy.spec

  # scale_y_continuous(limits=c(0.9985,1)) +

# pdf(file = "mlcCBMfamsSpecSens.pdf", width = 11.25, height = 7)
p.cbm.fam = ggplot(cbm_cazy_fam_spec_recall_df, aes(x=Recall, y=Specificity)) +
  geom_density_2d_filled(alpha = 0.5, contour_var = "ndensity", bins=10, aes(x=Recall_Noise, y=Specifcity_Noise)) +
  geom_point(size=1.1, aes(x=Recall, y=Specificity)) +
  scale_color_manual(values=colour_set) +
  theme(plot.background = element_rect(fill = figbg, color = figbg),
...
#####
# these figures are created and then merged together mannually in another programme for inclusion in publications and the thesis
# tiff(file = "cbmPoorFamsFbeta.tiff", units="cm", width = 15.5, height = 24, res=600)
...
# tiff(file = "cbmPoorFamsPops.tiff", units="cm", width = 15.5, height = 20, res=600)
