...
def extract_assembly(accession_number):
    """The function extract_assebly pulls down genomic sequences from the NCBI assembly database.
...
def get_accession_numbers(accession_numbers_file):
    """The get_accession_numbers function extracts accession numbers from a plain text file

    This function extract the accession numbers of genomic sequences stored in the NCBI assembly database.
...
def store_ncbi_data(working_accession_number, NCBI_data):
    """ The store_ncbi_data function stores data pulled down from NCBI in a new file.
